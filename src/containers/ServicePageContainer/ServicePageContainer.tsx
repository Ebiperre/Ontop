                ...
                <div className="bg-transparent flex justify-center flex-col pb-4 pt-3">
                    {giftCard.map((data)=>(
                        ...
                        <p key={Math.random()} className="text-xl font-medium">{data.title}</p>
                                            <div key={Math.random()} className="flex flex-wrap items-center justify-center gap-2 px-2 pt-3 pb-3">
                                            ...
                                            <div key={Math.random()} className=" p-4 md:flex md:gap-2 lg:gap-2">
                                                ...
                                                <div className="border-[0.3px] bg-transcard border-purple2 flex justify-center gap- w-full p-6 md:h-[158px]  lg:flex lg:justify-between lg:h-[144px]">
                                                    <div className="flex flex-col items-start">
                                                        <div className="w-20 h-11 border-r-2 border-purple border-b-2 flex items-start lg:w-[310px]">
                                                            <p className="text-lg font-medium">Face Value</p>
                                                        </div>
                                                        <div className="w-20 h-11 border-r-2 border-purple flex items-start lg:w-[310px] ">
                                                            <p className="text-lg font-medium">Rate</p>
                                                        </div>
                                                    </div>
                                                    <div  className="flex flex-col items-start lg:flex lg:justify-start lg:items-start">
                                                        <div className="border-b-2 border-purple h-11 pl-2  lg:w-[310px]">
