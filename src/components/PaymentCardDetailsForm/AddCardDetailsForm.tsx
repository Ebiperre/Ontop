...
const AddCardDetailsForm = ({ closeModal }: AddCardDetailsFormProps) => {
  ...
  const cardnumber = (inputtxt: string): string => {
    ...
    const verveRegEx =
      /^(?:506[0-9]{0,14}|650[0-9]{0,13}|6512[0-9]{0,12}|652[0-9]{0,13}|653[0-9]{0,14})$/;
    if (visa.test(cardno)) {
      cardtype1 = "visa";
  ...
  const validate = (): boolean => {
    ...
    if (!card.cardno.match(/^\d(?:\d{14}|\d{17})\d$/)) {
    ...
    <form action="" className="w-full">
      <div className="max-h-full w-full max-w-2xl m-4 mx-auto flex lgqw8 f0dty k3u76 jpq01 shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)]">
        <div className="p-4 flex azaj8 items-center bg8gm d1k81">
          <h3 className="font-semibold v7056 ">Add card details</h3>
          <button
            type="button"
            onClick={closeModal}
            className="w-8 gpe5b pqrvw pdrgo items-center dqqs4 iwtls l66z3 yj6bp em545 v7056 gk940 kko9e tk4f7 focus:outline-none focus:bg-gray-200"
            data-hs-overlay="#hs-pro-dmacm"
          >
            <span className="sr-only">Close modal</span>
            <svg
              className="flex-shrink-0 sfo8l h-4"
        ...
        <div className="p-4 pk1vk mws46 szov1 bp4e4 m2y1i">
          <div className="space-y-5">
            <div className="flex azaj8 items-center">
              <label
                htmlFor="hs-pro-decmcd"
                className="block tn07p dtjcu eass7 v7056 "
              >
                Card details
              </label>
              {getCardIcon()}
              ...
              <div>
                <div className="relative">
                  <div className="absolute vt6s4 atruh flex items-center ootlu c8qx6 cursor-pointer">
                    <svg
                      className="flex-shrink-0 sfo8l qcpnt fyxhw "
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
              ...
              <div className="grid zvyci gap-2">
                ...
                <div>
                  <input
                    required
                    type="password"
                    className={`py-2 vrf2y block w-full d1k81 nq4w8 dtjcu v7056 input-focus ${
                ...
                <div>
                  <input
                    ...
                    type="text"
                    className={`py-2 vrf2y block w-full d1k81 nq4w8 dtjcu ggbym input-focus kko9e tk4f7 ${
                      errors.expirydt ? "border-red-500" : ""
                    }`}
        ...
        <div className="w-full p-4 flex prqc8 items-center gap-x-2">
          <button
            type="button"
            onClick={closeModal}
            className="py-2 vrf2y pqrvw items-center dqqs4 dtjcu eass7 nq4w8 l66z3 d1k81 f0dty v7056 tgfrq cjy9h kko9e tk4f7 focus:outline-none focus:bg-gray-50 hover:bg-slate-300"
            data-hs-overlay="#hs-pro-dmacm"
          >
            Cancel
          </button>
          <button
            type="submit"
            onClick={handleSave}
            className="py-2 vrf2y pqrvw items-center dqqs4 dtjcu kxhcs nq4w8 l66z3 yj6bp wpeco dafkk nkmbv kko9e tk4f7 focus:outline-none focus:ring-2 focus:ring-orange bg-orange2 hover:bg-orange"
            data-hs-overlay="#hs-pro-dmacm"
          >
            Save
          </button>
