        ...
        <>
            ...
            <div className=" bg-text-color text-black px-[4vw] pt-[16vh]">
              ...
              <div >
                ...
                <div className="flex rounded-md overflow-hidden h-10 shadow-orange">
                            <div className="flex w-4/6">
                                <input className="flex-1 pl-2 outline-none" type="email" placeholder="Input Email:" />
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="font-semibold text-xl mb-3">About us</div>
                    <div className="font-extralight  flex flex-col gap-2 flex flex-col gap-2">
                      ...
                      <a className="hover:underline hover:text-purple hover:cursor-pointer">Become a rider</a>
                      <a className="hover:underline hover:text-purple hover:cursor-pointer">Transport your Goods</a>
                    </div>
                  </div>
                  <div>
